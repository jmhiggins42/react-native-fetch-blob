...
public class RNFetchBlob extends ReactContextBaseJavaModule {
    ...
    public void actionViewIntent(String path, String mime, final Promise promise) {
        try {
            Intent intent = new Intent(Intent.ACTION_VIEW).setDataAndType(Uri.parse("content://" + path), mime);
    ...
    @ReactMethod
    public void actionViewIntentWithProtocol(String path, String mime, final Promise promise) {
        try {
            Intent intent = new Intent(Intent.ACTION_VIEW).setDataAndType(Uri.parse(path), mime);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            this.getReactApplicationContext().startActivity(intent);
            ActionViewVisible = true;
